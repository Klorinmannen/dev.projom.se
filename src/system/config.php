...
class config {
    ...
    public function db(): array { return $this->_db; }
    public function src_dir(): string { return $this->_src_dir; }
    public function system_dir(): string { return $this->_system_dir; }
    public function conf_dir(): string { return $this->_conf_dir; }
